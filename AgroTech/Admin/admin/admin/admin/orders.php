...
<body class="prov">
  ...
  <tbody>
			...
			$sql = mysqli_query($conn, "SELECT * FROM `order` WHERE checkid > 1");
            ...
            <td><?php echo $key['LastName']?></td>
						...
						<td><?php echo $key['GoodID']?></td>
						<td><?php echo $key['amout']?></td>
						<td><?php echo $key['checkId']?></td>
        </tr>
				<?php
			}
			?>
